...
from rl_algorithm.common.misc_util import set_global_seeds
from rl_algorithm.common.save_util import data_to_json, json_to_data, params_to_bytes, bytes_to_params
from rl_algorithm.common.policies import get_policy_from_name, ActorCriticPolicy
from rl_algorithm.common.runners import AbstractEnvRunner
from rl_algorithm.common.vec_env import (VecEnvWrapper, VecEnv, DummyVecEnv,
                                             VecNormalize, unwrap_vec_normalize)
from rl_algorithm.common.callbacks import BaseCallback, CallbackList, ConvertCallback
...
class OffPolicyRLModel(BaseRLModel):
    ...
    def is_using_her(self) -> bool:
        ...
        from rl_algorithm.her.replay_buffer import HindsightExperienceReplayWrapper
