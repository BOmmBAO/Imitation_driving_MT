...
import rl_algorithm.common.tf_util as tf_util
from rl_algorithm.common.tf_util import total_episode_reward_logger
from rl_algorithm.common import explained_variance, zipsame, dataset, fmt_row, colorize, ActorCriticRLModel, \
    SetVerbosity, TensorboardWriter
from rl_algorithm import logger
from rl_algorithm.common.mpi_adam import MpiAdam
from rl_algorithm.common.cg import conjugate_gradient
from rl_algorithm.common.policies import ActorCriticPolicy
from rl_algorithm.common.misc_util import flatten_lists
from rl_algorithm.common.runners import traj_segment_generator
from rl_algorithm.TRPO.utils import add_vtarg_and_adv
...
class TRPO(ActorCriticRLModel):
    ...
    def setup_model(self):
        ...
        from rl_algorithm.gail.adversary import TransitionClassifier
