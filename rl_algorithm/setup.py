...
with open(os.path.join('rl_algorithm.stable_baselines', 'version.txt'), 'r') as file_handler:
...
from rl_algorithm.stable_baselines.common.vec_env import DummyVecEnv
...
setup(name='rl_algorithm.stable_baselines',
      packages=[package for package in find_packages()
                if package.startswith('rl_algorithm.stable_baselines')],
      package_data={
          'rl_algorithm.stable_baselines': ['py.typed', 'version.txt'],
      },
      install_requires=[
