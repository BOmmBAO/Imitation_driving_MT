...
from rl_algorithm.PETS_action.dmbrl.misc.optimizers import RandomOptimizer, CEMOptimizer
        ...
        if get_pred_trajs:
            ...
            def iteration(t, total_cost, cur_obs, pred_trajs):
                ...
                delta_cost = tf.reshape(
                    self.obs_cost_fn(next_obs, self.obs_index, self.rews_sigma) + self.ac_cost_fn(cur_acs), [-1, self.npart]
                )
