...
from rl_algorithm.stable_baselines.common.policies import BasePolicy, nature_cnn, register_policy
...
class FeedForwardPolicy(SACPolicy):
    ...
    def make_actor(self, obs=None, reuse=False, scope="pi"):
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            # the std depends on the state, so we cannot use rl_algorithm.stable_baselines.common.distribution
