...
import rl_algorithm.stable_baselines.common.tf_util as tf_util
from rl_algorithm.stable_baselines.common import explained_variance, zipsame, dataset, fmt_row, colorize, ActorCriticRLModel, \
    SetVerbosity, TensorboardWriter
from rl_algorithm.stable_baselines import logger
from rl_algorithm.stable_baselines.common.mpi_adam import MpiAdam
from rl_algorithm.stable_baselines.common.cg import conjugate_gradient
from rl_algorithm.stable_baselines.common.policies import ActorCriticPolicy
from rl_algorithm.stable_baselines.a2c.utils import total_episode_reward_logger
from rl_algorithm.stable_baselines.trpo_mpi.utils import traj_segment_generator, add_vtarg_and_adv, flatten_lists
...
class TRPO(ActorCriticRLModel):
    ...
    def setup_model(self):
        ...
        from rl_algorithm.stable_baselines.gail.adversary import TransitionClassifier
